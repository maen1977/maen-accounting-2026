...
- مؤشرات الربح الإجمالي ومتوسط صافي السجل في لوحة التحكم والتقارير.
...
- ثلاث تجارب مستقلة: حسابات الأفراد، حسابات الشركات، و«محفظتي» للسجل النقدي والبنكي المبسط.
- قسم «محفظتي» معزول محليًا في SQLite وسحابيًا في مجموعة Firestore باسم `walletEntries`.
...
5. Firestore أصبح في المسار `users/{uid}/entries/{entryId}`، مع `personalEntries` للأفراد و`walletEntries` لمحفظتي.
